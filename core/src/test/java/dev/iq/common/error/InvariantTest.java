...
final class InvariantTest {
    ...
    public void testRequireTrueWithFalseCondition() {
        ...
        final var exception =
                Assertions.assertThrows(IllegalStateException.class, () -> Invariant.requireTrue(false, message));
    ...
    public void testRequireTrueWithComplexConditions() {
        ...
        Assertions.assertThrows(IllegalStateException.class, () -> Invariant.requireTrue(nullString != null, message));

        // Test with array bounds
        final var array = new int[5];
        Assertions.assertThrows(IllegalStateException.class, () -> Invariant.requireTrue(array.length > 10, message));
    }
    ...
    public void testAssertTrueWithFalseCondition() {
        ...
        final var error = Assertions.assertThrows(AssertionError.class, () -> Invariant.assertTrue(false, message));
    ...
    public void testAssertTrueWithComplexConditions() {
        ...
        // Test with null check
        final String nullString = null;
        Assertions.assertThrows(AssertionError.class, () -> Invariant.assertTrue(nullString != null, message));

        // Test with mathematical condition
        Assertions.assertThrows(AssertionError.class, () -> Invariant.assertTrue(Math.PI > 4.0, message));
    }
    ...
    public void testRequireTrueVsAssertTrueExceptionTypes() {
        ...
        Assertions.assertThrows(AssertionError.class, () -> Invariant.assertTrue(false, message));
    }
}
