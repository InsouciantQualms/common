...
/**
 * Contains utilities to facilitate using Iterable instances. These methods will always return an
 * immutable version of an iterable. For items that normally mutate one in place (like a sort
 * operation), an immutable copy will be returned.
 */
public final class Iterables {
    ...
    /**
     * Sorts the specified Iterable with the comparator supplied. Note that this is not an in-place
     * sort. Rather, the Iterable is a new instance.
     *
