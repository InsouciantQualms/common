...
/**
 * Contains utilities to facilitate using Iterable instances.  These methods will always return
 * an immutable version of an iterable.  For items that normally mutate one in place (like a sort
