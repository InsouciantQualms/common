...
/**
 * Helper class to query the location of where a class has been loaded from (its CodeSource).
 * This can be used to resolve the containing JAR or build folder, as examples.  Note that resolution
 * will depend on the calling class passed in, as each may be loaded from different JAR files.
 */
