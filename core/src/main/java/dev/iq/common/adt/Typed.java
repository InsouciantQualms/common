...
public final class Typed {
     ...
     */
    public static <A, B> Typed2<A, B> of(final A a, final B b,
        final Class<A> classA, final Class<B> classB
    ) {
     ...
     */
    public static <A, B, C> Typed3<A, B, C> of(final A a, final B b, final C c, final Class<A> classA, final Class<B> classB,
        final Class<C> classC
    ) {
        Objects.requireNonNull(classA);
        Objects.requireNonNull(classB);
