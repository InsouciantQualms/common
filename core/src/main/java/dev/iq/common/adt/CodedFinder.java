...
import dev.iq.common.collection.Streams;
...
/**
 * Searches various data structures which implement the Coded interface.  This finder is useful
 * when retrieving a value from, say, a database and wanting to map that to a specific enum
 * constant, collection item or array item.
 */
