...
/**
 * Helper utilities for working with Versioned instances.
 */
public final class Versions {
    ...
    public static <E extends Versioned> List<E> allActive(final Iterable<E> items) {

        return Streams.from(items).filter(v -> v.expired().isEmpty()).toList();
    }
