...
/**
 * Abstract class that encapsulates simple threading functionality. This runnable will continue to
 * execute as long as the implementors of the go() method return true. It will exit once a false is
 * received or once kill9() is called.
 */
public abstract class SimpleRunnable implements Runnable {
    ...
    /**
     * Subclasses must implement this event, which is called by the run() method. Return true to
     * continue processing or false to exit the therad.
     *
